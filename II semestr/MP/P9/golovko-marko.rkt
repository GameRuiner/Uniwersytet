...
(define (op->proc op m)
  (cond [(eq? op '+) +]
        ...
        [(eq? op 'mod) modulo]
        [(eq? op 'rand) (lambda (max) (car ((rand max)(get-mem 'seed m))))])) ; chosen by fair dice roll.
...
;; test
(print 511)
(probably-prime? 511 20)
(print 500)
(probably-prime? 500 20)
(print 521)
(probably-prime? 521 20)
(print 541)
(probably-prime? 541 20)
(print 2)
(probably-prime? 2 20)
(print 3)
(probably-prime? 3 20)
